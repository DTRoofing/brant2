...
.PHONY: help setup up dev down stop logs status health build restart clean test test-e2e test-integration organize-docs
...
help:
	...
	@echo "  test-unit      : Run only the unit tests."
...
up:
	@echo "🚀 Starting local profile services in detached mode..."
...
build:
	@echo "🏗️ Building local profile service images..."
...
test-unit:
	...
	docker-compose exec api pytest -m "not integration and not e2e"
...
test-integration:
	...
	@# Ensure the test environment is torn down even if tests fail
	@docker-compose -f docker-compose.test.yml exec test-api pytest tests/integration/; EXIT_CODE=$$? ; \
